...
import { PantallaModeloCalidad } from "../ElementosEconomicos/PantallaModeloCalidad";
...
export class MovimientoPantallaDetalle extends Model
{
    ...
    @Prop.Set( PropBehavior.model, () => PantallaModeloCalidad ) pantalla?: PantallaModeloCalidad;
